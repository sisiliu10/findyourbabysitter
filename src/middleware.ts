...
const publicPaths = ["/", "/login", "/register", "/verify-email", "/api/auth/register", "/api/auth/login", "/api/auth/logout", "/api/auth/verify-email", "/api/auth/resend-verification", "/babysitter"];
